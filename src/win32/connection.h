...
extern const char* connection_get_host_address(void); /* thread-safe */
extern const char* connection_get_client_address(void); /* thread-safe */
extern bool connection_is_connected(void); /* thread-safe */
